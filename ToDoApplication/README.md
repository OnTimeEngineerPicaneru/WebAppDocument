...
- Flask-WTFによるCSRF対策を全POSTフォームへ追加
- ログアウトをGETからPOSTへ変更
- ユーザー登録・タスク追加・編集の入力検証を追加
- ユーザーIDとタスク名の重複エラー処理を追加
- タスクステータスをEnumの許可値に限定
- ホーム画面にログイン中のユーザー名を表示
